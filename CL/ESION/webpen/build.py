...
[data-pencil-name="Voices"] [data-pencil-name="row"] > div{opacity:0;transform:translateY(16px);transition:opacity 1s cubic-bezier(.2,.7,.2,1),transform 1s cubic-bezier(.2,.7,.2,1);transition-delay:0.2s;}
.rvtext.shown,
