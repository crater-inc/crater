...
(function(){
 ...
 // ---- チェックリスト内リンク（太字・青文字＝リンク指示） ----
 var CHECKLIST_LINKS={'link-flexorder':'https://esion.jp/shop/pages/flexorder','link-30days':'https://esion.jp/shop/pages/30days'};
 Object.keys(CHECKLIST_LINKS).forEach(function(name){
